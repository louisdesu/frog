...
def loadData_shimmer(filepath):
    data = pd.read_csv(filepath, sep=',') #, skiprows=(0,1))  # louis edited 10-09-20

    orig_cols = data.columns
    rename_cols = {}

    for search, new_col in [['timestamp','Timestamp'], 
                            ['accel_x', 'AccelX'], ['accel_y', 'AccelY'], ['accel_z', 'AccelZ'],  # louis edited 10-09-20
                            ['ts', 'EDA']]:  # louis edited 10-09-20
    ...
    # data = data[data['Timestamp'] != 'ms'] # louis edited 10-09-20
